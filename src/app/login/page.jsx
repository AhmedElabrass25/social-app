"use client";
import { setToken } from "../_redux/authSlice";
...
const Login = () => {
  ...
  const handleLogin = async (values) => {
    try {
      ...
      setError(error?.response?.data?.error || "There is error in login");
      toast.error(error?.response?.data?.error || "There is error in login");
    } finally {
      setLoading(false);
    }
  };
    ...
    <section className="mt-10">
      <div className="container h-full">
        <div className="row flex items-center justify-center h-full">
          ...
          >
            <h1 className="text-center text-2xl mb-5">Login Page</h1>
            <div className="content w-full flex items-center justify-center flex-col">
              ...
              <p className="text-xl mb-2 group text-center">
